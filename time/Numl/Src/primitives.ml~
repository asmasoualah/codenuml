    ...
    Lambda("x",TFloat(ref s1,ref u1,ref p1),
           Lambda("y",TFloat(ref s2,ref u2,ref p2),
                  App(App(App(App(App(App(Pi("ss1",TInt,
                                          ...
                                          Pi("ss2",TInt,
                                          Pi("uu2",TInt,
                                          Pi("pp2",TInt,Plus(Id("x"),Id("y"),u,p)))))))
                    ,s1),u1),p1),s2),u2),p2)  )) ;;


let newMinusVar u p = let u1 = newTypeVar () in
  let s1 = newTypeVar () in
  let u1 = newTypeVar () in
  let p1 = newTypeVar () in
  let s2 = newTypeVar () in
    ...
    Lambda("x",TFloat(ref s1,ref u1,ref p1),
           Lambda("y",TFloat(ref s2,ref u2,ref p2),
                  App(App(App(App(App(App(Pi("ss1",TInt,
                                          ...
                                          Pi("ss2",TInt,
                                          Pi("uu2",TInt,
                                          Pi("pp2",TInt,Minus(Id("x"),Id("y"),u,p)))))))
                    ,s1),u1),p1),s2),u2),p2)  )) ;;
					
					
					
let newMultVar u p = let u1 = newTypeVar () in
  let s1 = newTypeVar () in
  let u1 = newTypeVar () in
  let p1 = newTypeVar () in
  let s2 = newTypeVar () in
    ...
    Lambda("x",TFloat(ref s1,ref u1,ref p1),
           Lambda("y",TFloat(ref s2,ref u2,ref p2),
                  App(App(App(App(App(App(Pi("ss1",TInt,
                                          ...
                                          Pi("ss2",TInt,
                                          Pi("uu2",TInt,
                                          Pi("pp2",TInt,Mult(Id("x"),Id("y"),u,p)))))))
                    ,s1),u1),p1),s2),u2),p2)  )) ;;


let newDivVar u p = let u1 = newTypeVar () in
  let s1 = newTypeVar () in
  let u1 = newTypeVar () in
  let p1 = newTypeVar () in
  let s2 = newTypeVar () in
  ...
  let p2 = newTypeVar () in 
    Pi("x",TFloat(ref s1,ref u1,ref p1),Pi("y",TFloat(ref s2,ref u2,ref p2),
                                        TFloat(ref (SigPlus(s1,u1,s2,u2)),
                                               ...
                                               ref (IMinus(IMinus(IPlus(IMax(u1,u2),Int(1)),
